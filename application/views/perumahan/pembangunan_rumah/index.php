...
<div class="container-fluid">
    <form action="<?php echo base_url('perumahan/pembangunan_rumah/delete_selected') ?>" method="POST">
        <div class="card shadow mb-4 ">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-success  mb-3 ml-auto" href="<?php echo base_url('perumahan/pembangunan_rumah/add') ?>">
                    <span class="icon">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($dataSatu->result_array() as $key) : ?>
                                <tr>
                                    ...
                                    <td><input type="checkbox" name="id[]" value="<?php echo $key['id_pembangunan']; ?>"></td>
                                    <td><?php echo ++$start; ?></td>
                                    <td><?php echo $key['kabupaten']; ?></td>
                                    <td><?php echo $key['kecamatan']; ?></td>
                                    <td><?php echo $key['kelurahan']; ?></td>
                                    <td><?php echo $key['unit']; ?></td>
                                    <td><?php echo $key['mbr']; ?></td>
                                    <td><?php echo $key['imb']; ?></td>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('perumahan/rtlh/update/') ?><?php echo $key['id_pembangunan'] ?>"><span class="badge badge-primary">ubah</span></a>
                                        <a href=" <?php echo base_url('perumahan/rtlh/delete/') ?><?php echo $key['id_pembangunan'] ?>"><span class="badge badge-danger" onclick="return confirm('Apakah Anda Yakin Menghapus ?')">hapus</span></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
