    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Kawasan  Surat Keterangan Kumuh Add</h3>
            </div>
            <?php echo form_open('kawasan__surat_keterangan_kumuh/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="sk" value="<?php echo $this->input->post('sk'); ?>" class="form-control" id="sk" />
