    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Perumahan  Spm Add</h3>
            </div>
            <?php echo form_open('perumahan__spm/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_pekerjaan_spm" class="form-control">
								...
								{
									$selected = ($perumahan_dropdown__pekerjaan_spm['id_pekerjaan_spm'] == $this->input->post('id_pekerjaan_spm')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="jml_rumah_ditangani" value="<?php echo $this->input->post('jml_rumah_ditangani'); ?>" class="form-control" id="jml_rumah_ditangani" />
						</div>
					</div>
					<div class="col-md-6">
