	...
	<div class="col-md-12">
		<div class="box box-info">
			<!-- <div class="box-header with-border">
				<h3 class="box-title">Perumahan Rtlh Add</h3>
			</div> -->
			<?php echo form_open('perumahan__rtlh/add'); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="unit_pbdt" value="<?php echo $this->input->post('unit_pbdt'); ?>" class="form-control" id="unit_pbdt" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="unit_dtpfmotm" value="<?php echo $this->input->post('unit_dtpfmotm'); ?>" class="form-control" id="unit_dtpfmotm" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="unit_dtks" value="<?php echo $this->input->post('unit_dtks'); ?>" class="form-control" id="unit_dtks" />
