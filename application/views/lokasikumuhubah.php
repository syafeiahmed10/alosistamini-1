        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4 ">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo base_url('admin/'); ?>lokasi_kumuh_aksi_ubah" method="POST">
                        ...
                        <a class="btn btn-danger float-left ml-1" href="<?php echo base_url('admin/lokasi_kumuh') ?>">Batal</a>
                    </form>
                </div>
            </div>
        </div>
