    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Kawasan  Lokasi Kumuh Edit</h3>
            </div>
			<?php echo form_open('kawasan__lokasi_kumuh/edit/'.$kawasan__lokasi_kumuh['id_lokasi']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="village_id" class="form-control">
								...
								{
									$selected = ($reg__village['id'] == $kawasan__lokasi_kumuh['village_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_sk" class="form-control">
								...
								{
									$selected = ($kawasan__surat_keterangan_kumuh['id_sk'] == $kawasan__lokasi_kumuh['id_sk']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="lokasi" value="<?php echo ($this->input->post('lokasi') ? $this->input->post('lokasi') : $kawasan__lokasi_kumuh['lokasi']); ?>" class="form-control" id="lokasi" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="luas" value="<?php echo ($this->input->post('luas') ? $this->input->post('luas') : $kawasan__lokasi_kumuh['luas']); ?>" class="form-control" id="luas" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="rt_rw" value="<?php echo ($this->input->post('rt_rw') ? $this->input->post('rt_rw') : $kawasan__lokasi_kumuh['rt_rw']); ?>" class="form-control" id="rt_rw" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="lintang" value="<?php echo ($this->input->post('lintang') ? $this->input->post('lintang') : $kawasan__lokasi_kumuh['lintang']); ?>" class="form-control" id="lintang" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="bujur" value="<?php echo ($this->input->post('bujur') ? $this->input->post('bujur') : $kawasan__lokasi_kumuh['bujur']); ?>" class="form-control" id="bujur" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tingkat_kumuh" value="<?php echo ($this->input->post('tingkat_kumuh') ? $this->input->post('tingkat_kumuh') : $kawasan__lokasi_kumuh['tingkat_kumuh']); ?>" class="form-control" id="tingkat_kumuh" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="last_update" value="<?php echo ($this->input->post('last_update') ? $this->input->post('last_update') : $kawasan__lokasi_kumuh['last_update']); ?>" class="form-control" id="last_update" />
