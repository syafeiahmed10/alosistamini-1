...
class Model_pembangunan_rumah extends CI_Model
{
    public function get_table($limit, $start)
    {
        ...
        $this->db->join('reg_villages', 'reg_villages.id=perumahan__pembangunan_rumah.village_id', 'LEFT');
